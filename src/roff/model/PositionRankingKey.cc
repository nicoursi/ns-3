...
uint32_t
PositionRankingKey::GetLowerDistanceLimit () const
{
  return m_lowerDistanceLimit;
}

uint32_t
PositionRankingKey::GetUpperDistanceLimit () const
{
  return m_upperDistanceLimit;
}

bool
PositionRankingKey::operator< (const PositionRankingKey& other) const
{
  return m_lowerDistanceLimit < other.m_lowerDistanceLimit;
}

bool
PositionRankingKey::IsInRange (const uint32_t distance) const
{
