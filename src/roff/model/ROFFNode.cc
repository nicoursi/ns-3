...
//	Getters
Ptr<Node>
ROFFNode::GetNode () const
{
  return m_node;
}

Ptr<Socket>
ROFFNode::GetSocket () const
{
  return m_socket;
}

bool
ROFFNode::GetReceived () const
{
  return m_received;
}

bool
ROFFNode::GetSent () const
{
  return m_sent;
}

bool
ROFFNode::GetScheduled () const
{
  return m_scheduled;
}

uint32_t
ROFFNode::GetId () const
{
  return m_node->GetId ();
}

const Vector
ROFFNode::GetPosition () const
{
  return m_position;
}

int32_t
ROFFNode::GetPhase () const
{
  return m_phase;
}

uint32_t
ROFFNode::GetSlot () const
{
  return m_slot;
}

uint32_t
ROFFNode::GetHop () const
{
  return m_hop;
}

Time
ROFFNode::GetTimestamp () const
{
  return m_timestamp;
}

bool
ROFFNode::AmIInJunction () const
{
  NS_LOG_FUNCTION (this);
...
bool
ROFFNode::GetStopSending (void) const
{
  NS_LOG_FUNCTION (this);
...
//	Setters
void
ROFFNode::SetNode (Ptr<Node> node)
{
  m_node = node;
}

void
ROFFNode::SetSocket (Ptr<Socket> socket)
{
  m_socket = socket;
}

void
ROFFNode::SetReceived (bool received)
{
...
void
ROFFNode::SetSent (bool sent)
{
  m_sent = sent;
}

void
ROFFNode::SetScheduled (bool scheduled)
{
  m_scheduled = scheduled;
}

void
ROFFNode::SetPhase (int32_t phase)
{
  m_phase = phase;
}

void
ROFFNode::SetSlot (uint32_t slot)
{
  m_slot = slot;
}

void
ROFFNode::SetHop (uint32_t hop)
{
  m_hop = hop;
}

void
ROFFNode::SetTimestamp (Time timestamp)
{
  m_timestamp = timestamp;
}

void
ROFFNode::SetMeInJunction (bool value)
{
...
void
ROFFNode::SetJunctionId (uint64_t junctionId)
{
...
void
ROFFNode::SetStopSending (bool stopSending)
{
...
void
ROFFNode::SetMeAsVehicle (bool vehicle)
{
...
void
ROFFNode::Send (Ptr<Packet> packet)
{
...
void
ROFFNode::AddOrUpdateNeighbor (uint32_t nodeId, Vector pos, Time timeStamp)
{
...
uint32_t
ROFFNode::GetNBTSize () const
{
  return m_neighborTable.GetNBTSize ();
}

boost::dynamic_bitset<>
ROFFNode::GetESDBitmap (uint32_t distanceRange) const
{
...
bool
ROFFNode::IsNodeWinnerInContention (uint32_t dist, Vector pos) const
{
  return m_neighborTable.IsNodeWinnerInContention (GetId (), dist, pos);
}

const Vector
ROFFNode::UpdatePosition ()
{
  NS_LOG_FUNCTION (this);
